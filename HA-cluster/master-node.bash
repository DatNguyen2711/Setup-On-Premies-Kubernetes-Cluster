...
IPADDR="IP address of Load balancer"
NODENAME=$(hostname -s)
POD_CIDR="192.168.0.0/16"

# Init the HA Cluster
kubeadm init --control-plane-endpoint="$IPADDR:6443" \ # VIP of your Load Balancer
                    --upload-certs  \
                    --apiserver-cert-extra-sans="$IPADDR" \ # VIP of your Load Balancer
...
curl -k https://$IPADDR:6443/healthz
